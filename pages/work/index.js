      ...
      request.doPostRequest({
        ...
        success: res => {
          ...
          switch (temp) {
            case 2:
              ddUtils.navigateTo({
                url: `/pages/work/page/bidDocumentDetail/bidDocumentDetail?examineId=${examineId}&id=${id}&approvalType=1&forwardType=${forwardType}`
              });
              break;
            case 3:
              ddUtils.navigateTo({
                url: `/pages/work/page/contractApprovalDetail/contractApprovalDetail?examineId=${examineId}&id=${id}&approvalType=1&forwardType=${forwardType}`
              });
              break;
            case 4:
              ddUtils.navigateTo({
                url: `/pages/work/page/addPaymentDetail/addPaymentDetail?id=${id}&projectId=${projectId}&showType=${1}&examineId=${examineId}&forwardType=${forwardType}`
              });
              break;
            // case 5:
            //   ddUtils.navigateTo({
            ...
            case 8:
              ddUtils.navigateTo({
                url: `/pages/work/page/projectInfo/projectInfo?examineId=${examineId}&id=${id}&approvalType=1&forwardType=${forwardType}`
              });
              break;
            case 9:
              ddUtils.navigateTo({
                url: `/pages/work/page/beCompletedRegisterDetail/beCompletedRegisterDetail?examineId=${examineId}&id=${id}&approvalType=1&forwardType=${forwardType}`
              });
              break;
          }
          // return res
